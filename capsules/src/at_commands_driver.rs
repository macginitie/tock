...
pub static mut TX_BUF: [u8; 1024] = [0; 1024];
pub static mut RX_BUF: [u8; 1024] = [0; 1024];

pub struct AtCommands<'a, U: UartReceiveUntilTerminator> {
    uart: &'a U,
    apps: Grant<App>,
...
impl<U: UartReceiveUntilTerminator> AtCommands<'a, U> {
    pub fn new(
        uart: &'a U,
...
impl<U: UartReceiveUntilTerminator> Driver for AtCommands<'a, U> {
        ...
        match cmd_num {
            ...
            1 => {
                ...
                self.apps.enter(appid, |app, _| {
                    app.tx_buffer.take().map_or(ReturnCode::ENOMEM, |slice| {
...
impl<U: UartReceiveUntilTerminator> hil::uart::Client for AtCommands<'a, U> {
